...
```shell
pip install auto_gptq-0.2.0+cu118-cp310-cp310-linux_x86_64.whl # install v0.2.0 auto_gptq pre-build wheel in a environment whose python=3.10 and cuda=11.8
```
